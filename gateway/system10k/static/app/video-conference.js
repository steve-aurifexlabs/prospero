...
function addPeerElement(toEmail) {
    ...
    peerScreenElement.ondurationchange = function(event) {
        console.log(event)
        
        if(peerScreenElement.mainVideo && peerScreenElement.srcObject) {
            peerScreenElement.mainVideo.srcObject = peerScreenElement.srcObject
        }
    }    
...
function createPeerConnection(toEmail, channel) {
    ...
    var peerConnection = new RTCPeerConnection({
        iceServers: [{
            urls: ['stun:' + envPrefix + 'stun.' + nodeId + ".prospero.live:3478"],
            // username: 'username',
