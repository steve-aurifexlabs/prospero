...
function createFileView(name, path) {
    ...
    fetch('/api/fs/file?team=' + encodeURIComponent(team.teamId) + '&path=' + encodeURIComponent(path) + '&filename=' + encodeURIComponent(name) , {
        ...
        if (response.ok) {
            ...
            else if(name.slice(-4).toLowerCase() == '.ico') {
                return response.blob()
            }
        ...
        else if(name.slice(-4).toLowerCase() == '.jpg' || name.slice(-5).toLowerCase() == '.jpeg' || name.slice(-4).toLowerCase() == '.png' || name.slice(-4).toLowerCase() == '.ico' || name.slice(-4).toLowerCase() == '.gif') {
